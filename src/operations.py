...
def ShearX(img, v):  # [-0.3, 0.3]
    ...
    if random_mirror and random.random() > 0.5:
        v = -v
    return img.transform(img.size, PIL.Image.AFFINE, (1, v, 0, 0, 1, 0))    # data is first two row of affine matrix
...
# parameters: img(PIL image), name(operation name), level(magnitude 0~1)
